$(document).ready(function() {
	...
	$('<a href="#top" id="top_link"><img src="../image/auto/top.jpg" width="30" title = "返回顶部" height="30"/></a>').appendTo('body');
...
function ajaxGlobalHandlers(){
	//$('<div id="loading_wrap"><div id="loading_content"><img src="../image/auto/top.jpg" width="32" height="32" title = "返回顶部"/></div></div>').appendTo('body');		
